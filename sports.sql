...
(9999, 'cricket', 'cricket-boys-one-day', 'male', 15);
...
INSERT INTO `contestant` (`contestant_id`, `category_id`, `team_id`, `solo_id`) VALUES
(2, 9999, NULL, '20BCS999');
...
--
ALTER TABLE `category`
  MODIFY `category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;
